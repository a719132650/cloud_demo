package org.example.user.kgDao;
/*
author : Kigooo
verson : 0.0.3
...
public interface KgMenuDao {
    ...
    @Results({
            ...
            @Result(column = "menuSubOID=oid,init=init",property = "children",javaType = List.class,
    ...
    @Results({
            @Result(column ="oid" ,property ="oid"),
            @Result(column = "menuOID=oid,init=init",property = "children",javaType = List.class,
    ...
    @Results({
            @Result(column ="oid" ,property ="oid"),
            @Result(column = "oid",property = "children",javaType = List.class,
