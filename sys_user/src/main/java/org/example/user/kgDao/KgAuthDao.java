...
public interface KgAuthDao {
    ...
    @Results({
            ...
            @Result(column = "{menuSubOID=oid,userOID=userOID}",property = "children",javaType = List.class,
    ...
    @Results({
            @Result(column ="oid" ,property ="oid"),
            @Result(column = "{menuOID=oid,userOID=userOID}",property = "children",javaType = List.class,
